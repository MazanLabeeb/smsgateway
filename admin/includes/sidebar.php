      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link  <?php if($page == "index.php") echo "active"; ?>" id="dashboardbtn" aria-current="page" href="index.php">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($page == "send.php") echo "active"; ?>" id="sendbtn" href="send-bulk.php">
            ...
            <li class="nav-item">
              <a class="nav-link  <?php if($page =="send2.php") echo "active"; ?>"" href="send-single.php" id="sendbtn2">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($page =="addusers.php") echo "active"; ?>" href="addusers.php">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($page == "changeapi.php") echo "active"; ?>" href="changeapi.php">
          ...
          <li class="nav-item">
            <a class="nav-link  <?php if ($page == "statistics.php") echo "active"; ?>" href=" statistics.php">
